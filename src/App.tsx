...
export const App = () => {
  ...
  useEffect(() => {
    ...
    window.gtag('event', '7796_landing_impression', { var: 'var1' });
  }, []);
      ...
      return (
        <>
          ...
          <PureCell
            className={appSt.box}
            onClick={() => {
              window.gtag('event', '7796_about_click', { var: 'var1' });
          ...
          <Button
            view="primary"
            onClick={() => {
              window.gtag('event', '7796_show_all_click', { var: 'var1', answer: 'ОПИФ' });
              setView('all-O');
            }}
          >
            Показать все
          ...
          <Button
            view="primary"
            onClick={() => {
              window.gtag('event', '7796_show_all_click', { var: 'var1', answer: 'БПИФ' });
              setView('all-B');
            }}
          >
            Показать все
          ...
          <Button
            view="primary"
            onClick={() => {
              window.gtag('event', '7796_ba_open_click', { var: 'var1' });
      ...
      <>
        ...
        <div className={appSt.bottomBtn}>
          <Button
            ...
            size={56}
            onClick={() => {
              window.gtag('event', '7796_show_all_fonds_click', { var: 'var1' });
          ...
          <Swiper slidesPerView="auto" spaceBetween={8}>
            <SwiperSlide style={{ width: 'fit-content' }}>
              <Tag
                ...
                onClick={() => {
                  window.gtag('event', '7796_tab_click', { var: 'var1', answer: 'Все типы' });
                  setCategory('all');
                }}
            ...
            {categories.map(cat => (
              <SwiperSlide key={cat} style={{ width: 'fit-content' }}>
                <Tag
                  ...
                  onClick={() => {
                    window.gtag('event', '7796_tab_click', { var: 'var1', answer: cat });
