...
export const App = () => {
  ...
  useEffect(() => {
    ...
    window.gtag('event', '7953_landing_impression', { var: 'var1' });
  }, []);
      ...
      return (
        <>
          ...
          <PureCell
            className={appSt.box}
            onClick={() => {
              window.gtag('event', '7953_about_click', { var: 'var1' });
          ...
          <Button
            view="primary"
            onClick={() => {
              window.gtag('event', '7953_show_all_click', { var: 'var1', answer: 'ОПИФ' });
              setView('all-O');
            }}
          >
            Показать все
          ...
          <Button
            view="primary"
            onClick={() => {
              window.gtag('event', '7953_show_all_click', { var: 'var1', answer: 'БПИФ' });
              setView('all-B');
            }}
          >
            Показать все
          ...
          <Button
            view="primary"
            onClick={() => {
              window.gtag('event', '7953_ba_open_click', { var: 'var1' });
      ...
      <>
        ...
        <div className={appSt.bottomBtn}>
          <Button
            ...
            size={56}
            onClick={() => {
              window.gtag('event', '7953_show_all_fonds_click', { var: 'var1', dimension_1: 'ОПИФ' });
              setView('cats');
            }}
            block
          >
      ...
      <>
        ...
        <div className={appSt.bottomBtn}>
          <Button
            ...
            size={56}
            onClick={() => {
              window.gtag('event', '7953_show_all_fonds_click', { var: 'var1', dimension_1: 'БПИФ' });
          ...
          >
            <SwiperSlide style={{ width: 'fit-content' }}>
              <Tag
                ...
                onClick={() => {
                  window.gtag('event', '7953_tab_click', { var: 'var1', answer: 'Все типы' });
                  setCategory('all');
                }}
            ...
            {categories.map(cat => (
              <SwiperSlide key={cat} style={{ width: 'fit-content' }}>
                <Tag
                  ...
                  onClick={() => {
                    window.gtag('event', '7953_tab_click', { var: 'var1', answer: cat });
        ...
        <>
          ...
          <div className={appSt.bottomBtn}>
            <Button
              ...
              size={56}
              onClick={() => {
                window.gtag('event', '7953_show_all_fonds_click', { var: 'var1', dimension_1: category });
                setCategory('all');
              }}
              block
            >
